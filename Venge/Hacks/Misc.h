...
namespace Misc {
    ...
    void updateClanTag(bool = true) noexcept;
    void spectatorList() noexcept;
    void scopegunpoint() noexcept;
    void gunmovepoint() noexcept;
    ...
    constexpr void spacemove(UserCmd* cmd) noexcept
    {
        if (config.misc.spacemove && interfaces.entityList->getEntity(interfaces.engine->getLocalPlayer())->moveType() != MoveType::LADDER)

...
static int get_new_animation(const uint32_t model, const int sequence) noexcept
{
    enum Sequence
    {
		...
		SEQUENCE_UNI_DRAW = 0,
		SEQUENCE_UNI_DRAW2 = 1,
		SEQUENCE_UNI_LOOKAT01 = 13,
		SEQUENCE_UNI_LOOKAT03 = 13,
    };
    ...
    case fnv::hash("models/weapons/v_knife_falchion_advanced.mdl"):
    {
        ...
        case SEQUENCE_DEFAULT_LOOKAT01:
            if (rand() % 100 < 2)
                return SEQUENCE_FALCHION_LOOKAT02;
            else
                return SEQUENCE_FALCHION_LOOKAT01;
        case SEQUENCE_DEFAULT_DRAW:
	...
	case fnv::hash("models/weapons/v_knife_cord.mdl"):
	{
		...
		{
		case SEQUENCE_DEFAULT_DRAW:
			return random(SEQUENCE_UNI_DRAW, SEQUENCE_UNI_DRAW2);
		case SEQUENCE_DEFAULT_LOOKAT01:
			return random(SEQUENCE_UNI_LOOKAT01, SEQUENCE_UNI_LOOKAT03);
		default:
			return sequence + 1;
		}
	}
